      ...
      body: SafeArea(
        child: Column(
          ...
          Padding(
            ...
            child: Center(child: Text("Please feel free to give us your",style: TextStyle(color: Colors.white,fontSize: 20),))),
          Padding(
            padding: EdgeInsets.only(top: 20,left: 0),
            child: Center(child: Text("Feedback",style: TextStyle(color: Colors.white,fontSize: 20),))),
          ],
